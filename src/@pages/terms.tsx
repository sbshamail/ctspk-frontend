              ...
              <div className="pr-8 mb-8">
                ...
                <div className="mb-12 space-y-6 text-gray-700">
                  <p>
                    ...
                    our website (the "Service") operated by our company ("us", "we", or "our").
                  </p>
                  <p>
                  ...
                  <h4 className="text-xl font-semibold mt-8 mb-4 text-gray-900">Rights & Restrictions</h4>
                  ...
                  <h4 className="text-xl font-semibold mt-8 mb-4 text-gray-900">Links To Other Web Sites</h4>
                  <p>
                  ...
                  <h4 className="text-xl font-semibold mt-8 mb-4 text-gray-900">Termination</h4>
                  <p>
                  ...
                  <h4 className="text-xl font-semibold mt-8 mb-4 text-gray-900">Governing Law</h4>
                  <p>
                  ...
                  <h4 className="text-xl font-semibold mt-8 mb-4 text-gray-900">Changes</h4>
                  <p>
